...
void inst_tintirit (ZChannelRouter* router) {
    ...
    aoi3->place_term(ZOutputTerm,"Y",3,777);
    
    ZSymbolRef* xor6 = new ZSymbolRef("XOR6");
    xor6->place_term(ZInputTerm,"A",2,777);
    xor6->place_term(ZInputTerm,"B",4,777);
    xor6->place_term(ZInputTerm,"C",6,777);
    xor6->place_term(ZInputTerm,"D",8,777);
    xor6->place_term(ZInputTerm,"E",10,777);
    xor6->place_term(ZInputTerm,"F",12,777);   
    //xor6->place_term(ZOutputTerm,"Y",8,1);
    
    ZInst* i1 = new ZInst("AOI3_I1",aoi3,0,888);
    ZInst* i2 = new ZInst("AOI3_I2",aoi3,5,888);
    ZInst* i3 = new ZInst("AOI3_I3",aoi3,10,888);
    ZInst* i4 = new ZInst("AOI3_I4",aoi3,15,888);
    ZInst* i5 = new ZInst("AOI3_I5",aoi3,20,888);
    ZInst* i6 = new ZInst("AOI3_I6",aoi3,25,888);
    
    ZInst* i7 = new ZInst("XOR6_I7",xor6,15,888);
