...
void inst_tintirit (ZChannelRouter* router) {
    ...
    ZInst* i2 = new ZInst("AOI3_I2",aoi3,2,888);
    ZInst* i3 = new ZInst("AOI3_I3",aoi3,4,888);
    ZInst* i4 = new ZInst("AOI3_I4",aoi3,6,888);
    ZInst* i5 = new ZInst("AOI3_I5",aoi3,8,888);
    ZInst* i6 = new ZInst("AOI3_I6",aoi3,10,888);
    
    
    
    ZInst* i7 = new ZInst("XOR6_I7",xor6,0,888);
